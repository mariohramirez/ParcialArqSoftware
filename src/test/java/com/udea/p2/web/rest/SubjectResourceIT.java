...
class SubjectResourceIT {
    ...
    public static Subject createEntity(EntityManager em) {
        Subject subject = new Subject().name(DEFAULT_NAME).code(DEFAULT_CODE).teacher(DEFAULT_TEACHER);
        return subject;
    }
    ...
    public static Subject createUpdatedEntity(EntityManager em) {
        Subject subject = new Subject().name(UPDATED_NAME).code(UPDATED_CODE).teacher(UPDATED_TEACHER);
        return subject;
    }
    ...
    void createSubject() throws Exception {
        ...
        assertThat(testSubject.getTeacher()).isEqualTo(DEFAULT_TEACHER);
    }
    ...
    @Test
    @Transactional
    void checkTeacherIsRequired() throws Exception {
        int databaseSizeBeforeTest = subjectRepository.findAll().size();
        // set the field null
    ...
    void putExistingSubject() throws Exception {
        ...
        updatedSubject.name(UPDATED_NAME).code(UPDATED_CODE).teacher(UPDATED_TEACHER);
        ...
        assertThat(testSubject.getTeacher()).isEqualTo(UPDATED_TEACHER);
    }
    ...
    void fullUpdateSubjectWithPatch() throws Exception {
        ...
        partialUpdatedSubject.name(UPDATED_NAME).code(UPDATED_CODE).teacher(UPDATED_TEACHER);
